...
PGOPTIONS="--search_path=rxnorig" psql -U rxnorm <<EOF
...
PGOPTIONS="--search_path=rxnorig" psql -U rxnorm -f rxnorm-orig/RxNormDDL.sql
PGOPTIONS="--search_path=rxnorig" psql -U rxnorm -f rxnorm-orig/rxn_index.sql
PGOPTIONS="--search_path=rxnorig" psql -U rxnorm -f rxn_index_extra.sql
